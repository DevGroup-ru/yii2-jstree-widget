...
return [
    ...
    'There are two nodes with same "left" value. This should not be.' => 'Два элемента с одинаковым значением левого атрибута. Такого не должно быть.',
    'Can not move root node as child!' => 'Нельзя сделать корневой элемент дочерним!',
];